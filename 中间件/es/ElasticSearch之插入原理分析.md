...
为什么es在查询的时候，流程是这么相对简单些，因为查询的时候这数据基本是按照某种顺序存放的，所以在插入的时候会相对复杂些；

- es 写入数据的工作原理是什么？
- es 查询数据的工作原理是什么？见[上片文章](./ElasticSearch之查询性能分析.md)
- 底层的 lucene 是什么？
- 倒排索引了解吗？
...
![https://github.com/Zeb-D/my-review](../../image/es-write.png)
...
![https://github.com/Zeb-D/my-review](../../image/es-write-detail.png)
